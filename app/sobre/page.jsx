              ...
              <div className="flex flex-col  gap-4">
                ...
                <div className="max-w-[600px]">
                  ...
                  <p className="text-primary/85 text-sm">
                    ...
                    em 2025. <br />
                    <br /> Tenho familiaridade com programação, especialmente no
                    desenvolvimento web, e sou apaixonado por UI e UX design.{" "}
                    <br />
                    <br />
                    Acredito que uma boa interface não só torna um produto
                    visualmente atrativo, mas também essencial para proporcionar
                    uma experiência envolvente e intuitiva para o usuário.{" "}
                    <br />
